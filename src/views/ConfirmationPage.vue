<template>
  <ion-page>
    ...
    >
      ...
      <p class="px-4 mt-4">
        Your order <span>No. 19049585</span> has successfully take and now being
        processed. Kindly wait for our notification regarding your order.
      </p>
      <div class="flex flex-col items-center">
        <ion-button class="mt-[253px] pointer-events-none"
          >Track Order</ion-button
        >
        <ion-button fill="clear" :router-link="routes.DASHBOARD"
