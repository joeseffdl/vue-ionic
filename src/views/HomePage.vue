  ...
  <ion-page>
    <ion-header :translucent="true">
      <ion-toolbar>
        ...
        <ion-buttons slot="end">
          <ion-button>
            <ion-icon
              src="src/assets/svg/menu/profile_37.svg"
              class="size-[37px]"
              aria-hidden="true"
            ></ion-icon>
          </ion-button>
    ...
    <ion-content :fullscreen="true" class="ion-padding">
      <div class="flex gap-2 mt-7 mb-[22px] items-center">
        <ion-icon
          src="src/assets/svg/logo_67_72.svg"
          class="w-[67px] h-[72px]"
          aria-hidden="true"
        ></ion-icon>
        <div>
      ...
      <section class="grid">
        <ul class="w-full my-2 gap-2 flex">
          <li
            v-for="index in 2"
            class="grid place-items-center w-[312px] h-[138px] rounded-2xl bg-[#DEE2E6] px-4 py-3 text-[#6C757D] text-center text-sm font-semibold first:text-white first:bg-[--ion-color-primary]"
            :key="index"
          >
            {{ index }}
          </li>
      ...
      <SectionCard heading="Category" :quantity="2" width="200" height="300" />
      ...
      <ion-fab slot="fixed" vertical="bottom" horizontal="end">
        <ion-fab-button
          color="primary"
          aria-label="Order Now Action"
          :router-link="routes.ORDER_PAGE"
        >
          Order Now!
        </ion-fab-button>
      </ion-fab>
